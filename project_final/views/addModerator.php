...
while ($row=$result->fetch_assoc()) {
 ...
 ?>
	<form method="post" action="../controller/moderatorController.php" onsubmit="return validateForm()" name="myForm" >
<h1> <u> Add Moderator </u> </h1>
      <table align="center">
      ...
      <input class='inputSubmit' type="submit" name="addModerator" value="Add" >
      </td>
      </tr>
