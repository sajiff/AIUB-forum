...
<div style='margin-top:100px;' class="">
  <table align='center'>
      <form method="post" action="../controller/moderatorController.php" >
        ...
        <tr>
          ...
          <tr>
            ...
            <td colspan="2" align="center">  <input type="submit" class="inputSubmit" name="updateModerator" value="Update">
            </td>
          </tr>
