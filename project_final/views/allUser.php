...
<html lang="en" dir="ltr">
  ...
  <body>
    <div style='margin-top: 80px;'>
   	<table id="data">
   		<thead>
        <tr style=" background-color: Snow;"><td colspan="11"><h3 style="margin-top: 10px;">All Users</h3></td></tr>
   			<th>ID </th>
   			<th>First Name</th>
   			<th> Last Name </th>
         <th> User ID </th>
   		...
   		<tbody>
   			<?php
                   foreach ($admins as $admin) {
                       ...
                       echo '<td><a href="../views/editUser.php?$a='.$admin["id"].'" >Edit</a></td>';
                       echo '<td><a class="delete" href="deleteUser.php?$a='.$admin["id"].'">Delete</td>';
                       echo "</tr>";
                   }
               ?>
