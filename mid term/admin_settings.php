...
<ul id="menu"> 
<li id="home"> <a href="admin_home.php"> <u> <i> Home </i> </u> </a> </li>
<li id="profile"> <a href="admin_profile.php"> <u> <i> Profile </i> </u> </a> </li>
<li id="settings"> <a href="admin_settings.php"> <u> <i> Settings </i> </u> </a> </li>
</ul>
...
<div class="dropdown">
    <button class="dropbtn">Admin Settings
      <i class="fa fa-caret-down"></i>
    </button>
    <div class="dropdown-content">
      <a href="admin_reg.php">Add Admin</a>
      <a href="admin_moderator_reg.php">Add Moderator</a>
      <a href="#">Delete User</a>
	  <a href="#">Delete Moderator</a>
    </div>
  </div>
